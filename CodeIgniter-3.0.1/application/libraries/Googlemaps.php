...
class Googlemaps {
	...
	function create_map()
	{
		...
		if ($this->maps_loaded == 0)
		{
			...
			{
				//if ($this->https) { $apiLocation = 'https://maps-api-ssl'; }else{ $apiLocation = 'http://maps'; } - EDIT BY Cameron Winters (This wasn't working in Google Chrome for some reason - need HTTPS)
